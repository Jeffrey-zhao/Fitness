...
namespace Fit.FrontWeb.Controllers {
  public class HomeController : Controller {
    ...
    public ActionResult Introduce() {
      ...
      var introduceArr = introduces.Split(new char[] { Consts.SPLITER }, System.StringSplitOptions.RemoveEmptyEntries);
      var models = new List<IntroduceModel>();
      for (int i = 0; i < introduceArr.Length; i++) {
        var detalModelArr = introduceArr[i].Split(new char[] { Consts.SPLITER_DASH }, System.StringSplitOptions.RemoveEmptyEntries);
